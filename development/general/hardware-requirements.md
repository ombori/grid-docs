...
## Intel
A wide variety of Intel CPU-based devices are supported by Ombori Grid and GridOS. When [adding the device](/development/general/adding-device/) just make sure to follow the Intel (NUC) installation guide.
