...
| ------ | ----------------------------------------------------------------------------------- | -------------------------------------------------------------------- |
| GET    | [products](/development/grid/products/api?id=get-post-products)                     | Returns list of products based on specified query parameters         |
| GET    | [products/{id}](/development/grid/products/api?id=get-product-by-id)                | Retrieves specific product by ID                                     |
| GET    | [products-barcode/{code}](/development/grid/products/api?id=get-product-by-barcode) | Retrieves specific product by barcode value                          |
| GET    | [search](/development/grid/products/api?id=get-search)                              | Searches products or product types by keyword                        |
| POST   | [products/push](/development/grid/products/api?id=post-push-products)               | Pushes products into the database                                    |
| DELETE | [products](/development/grid/products/api?id=delete-remove-products)                | Removes specified product IDs from the database                      |
| PATCH  | [products](/development/grid/products/api?id=patch-update-products)                 | Update products listed in the database                               |
| PATCH  | [variants](/development/grid/products/api?id=patch-update-variants)                 | Update variants level information in the database                    |
| GET    | [product-types](/development/grid/products/api?id=get-product-types-list)           | Returns list of product types associated with the tenant index       |
| GET    | [product-types/{id}](/development/grid/products/api?id=get-product-type-details)    | Retrieves specific product type by id (ProductTypeId)                |
| POST   | [product-types](/development/grid/products/api?id=post-push-product-types)          | Pushes product types into the database                               |
| DELETE | [product-types](/development/grid/products/api?id=delete-remove-product-types)      | Removes specified product type IDs (ProductTypeId) from the database |
...
Reference: [GridProduct](/development/grid/products/data-model?id=gridproduct)
...
#### Response
Returns Partial<[`GridProduct`](/development/grid/products/data-model?id=gridproduct)>
...
Reference: [GridProduct](/development/grid/products/data-model?id=gridproduct), [ProductType](/development/grid/products/data-model?id=producttype)
...
#### Body
The body of the request should be an Array of [GridProducts]((/development/grid/products/data-model?id=gridproduct)) JSON format using the `content-type` header `application/json`.
...
Reference: [VariantUpdateFields](/development/grid/products/data-model?id=variantupdatefields) 
...
#### Response
Returns Array<[ProductType](/development/grid/products/data-model?id=producttype)>
...
#### Response
Returns [ProductType](/development/grid/products/data-model?id=producttype)
...
Reference: [ProductType](/development/grid/products/data-model?id=producttype)
